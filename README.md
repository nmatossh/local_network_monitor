...
Instalar dependencias de Python: pip install streamlit pandas

Configurar IPs: Edita el diccionario monitors en Dashboard.py con tus direcciones locales o remotas.

🚀 Ejecución / Execution
Windows (Modo App - Recomendado)
Simplemente haz doble clic en Monitor.vbs. Esto hará lo siguiente:

Inicia el servidor de Streamlit de forma invisible.

Abre una ventana dedicada de Chrome/Edge en modo aplicación.
